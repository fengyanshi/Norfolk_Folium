...
flood_NF_1=os.path.join('../saved_images','R1_smdm_hs.png')
flood_NF_2=os.path.join('../saved_images','R2_smdm_hs.png')
flood_NF_3=os.path.join('../saved_images','R4_smdm_hs.png')
flood_NF_4=os.path.join('../saved_images','R6_smdm_hs.png')
flood_NF_5=os.path.join('../saved_images','R3_smdm_hs.png')
flood_NF_6=os.path.join('../saved_images','R5_smdm_hs.png')

fld_bar=os.path.join('../saved_images','colorbar_hs.png')

m=folium.Map([36.96138,-76.27473],zoom_start=14.5,control_scale=True)

map_title = "Wave Height (FUNWAVE)"
...
m.save(os.path.join('../saved_maps', 'FUNWAVE_hs.html'))
m
