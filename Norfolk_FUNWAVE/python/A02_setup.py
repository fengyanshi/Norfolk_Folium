...
flood_NF_1=os.path.join('../saved_images','R1_smdm_setup.png')
flood_NF_2=os.path.join('../saved_images','R2_smdm_setup.png')
flood_NF_3=os.path.join('../saved_images','R4_smdm_setup.png')
flood_NF_4=os.path.join('../saved_images','R6_smdm_setup.png')
flood_NF_5=os.path.join('../saved_images','R3_smdm_setup.png')
flood_NF_6=os.path.join('../saved_images','R5_smdm_setup.png')

fld_bar=os.path.join('../saved_images','colorbar_setup.png')

m=folium.Map([36.96138,-76.27473],zoom_start=14.5,control_scale=True)

map_title = "Wave Setup (FUNWAVE)"
...
m.save(os.path.join('../saved_maps', 'FUNWAVE_setup.html'))
m
