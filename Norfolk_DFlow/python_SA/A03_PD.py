...
flood_NF=os.path.join('../saved_images','SA_PD_0.88.png')
flood_NF_1=os.path.join('../saved_images','SA_PD_0.76.png')
flood_NF_2=os.path.join('../saved_images','SA_PD_0.64.png')
...
map_title = "Scenarios: Pressure Drop"
...
m.save(os.path.join('../saved_maps', 'SA_PD.html'))
m
