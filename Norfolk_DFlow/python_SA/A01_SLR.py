...
flood_NF=os.path.join('../saved_images','SA_SLR_1.3m.png')
flood_NF_1=os.path.join('../saved_images','SA_SLR_0.8m.png')
flood_NF_2=os.path.join('../saved_images','SA_SLR_0.4m.png')

fld_bar=os.path.join('../saved_images','colorbar.png')

m=folium.Map([36.95,-76.291],zoom_start=14.2,control_scale=True)

map_title = "Scenarios: SLR"
...
m.save(os.path.join('../saved_maps', 'SA_SLR.html'))
m
