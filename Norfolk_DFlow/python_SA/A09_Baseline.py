...
#flood_NF=os.path.join('../saved_images','SA_WSF_0.925.png')
#flood_NF_1=os.path.join('../saved_images','SA_WSF_1.075.png')
#flood_NF_2=os.path.join('../saved_images','SA_WSF_1.225.png')
...
map_title = "Scenario: Baseline (Irene)"
...
m.save(os.path.join('../saved_maps', 'SA_Baseline.html'))
m
