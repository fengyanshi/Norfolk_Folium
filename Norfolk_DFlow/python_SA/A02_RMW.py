...
flood_NF=os.path.join('../saved_images','SA_RMW_1.25.png')
flood_NF_1=os.path.join('../saved_images','SA_RMW_1.1.png')
flood_NF_2=os.path.join('../saved_images','SA_RMW_0.9.png')

fld_bar=os.path.join('../saved_images','colorbar.png')

m=folium.Map([36.95,-76.291],zoom_start=14.2,control_scale=True)

map_title = "Scenarios: Radius of Max Wind"
...
m.save(os.path.join('../saved_maps', 'SA_RMW.html'))
m
