...
flood_NF_0=os.path.join('../saved_images','SA_Baseline.png')
flood_NF=os.path.join('../saved_images','SA_STE_138nm.png')
flood_NF_1=os.path.join('../saved_images','SA_STE_96nm.png')
flood_NF_2=os.path.join('../saved_images','SA_STE_54nm.png')
...
map_title = "Scenarios: Shifting Track to East"
...
m.save(os.path.join('../saved_maps', 'SA_STE.html'))
m
