...
flood_NF=os.path.join('../saved_images','SA_STW_54nm.png')
flood_NF_1=os.path.join('../saved_images','SA_STW_96nm.png')
flood_NF_2=os.path.join('../saved_images','SA_STW_138nm.png')
...
m.save(os.path.join('../saved_maps', 'SA_STW.html'))
m
