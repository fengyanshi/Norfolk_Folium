...
flood_NF=os.path.join('../saved_images','RMW_1.25.png')
flood_NF_1=os.path.join('../saved_images','RMW_1.1.png')
flood_NF_2=os.path.join('../saved_images','RMW_0.9.png')
...
m.save(os.path.join('../saved_maps', 'RMW.html'))
m
