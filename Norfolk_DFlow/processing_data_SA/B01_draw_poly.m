...
icount =0;
for i=1:N
 if Dep_ini_poly(i)<=0.0 && Dep_poly(i)>=1.0 && Y(i) > ycut
   icount=icount+1;
...
icount =0;
for i=1:N
 if Dep_ini_poly(i)<=0.0 && Dep_poly(i)<1.0 && Dep_poly(i)>=0.5 && Y(i) > ycut
   icount=icount+1;
 lon(1:4,icount)=WL(i).X(1:4);
 lon(5,icount)=WL(i).X(1);
 lat(1:4,icount)=WL(i).Y(1:4);
...
icount =0;
for i=1:N
 if Dep_ini_poly(i)<=0.0 && Dep_poly(i)<0.5 && Dep_poly(i)>=0.25 && Y(i) > ycut
   icount=icount+1;
 lon(1:4,icount)=WL(i).X(1:4);
 lon(5,icount)=WL(i).X(1);
 lat(1:4,icount)=WL(i).Y(1:4);
...
icount =0;
for i=1:N
 if Dep_ini_poly(i)<=0.0 && Dep_poly(i)<=0.25 && Dep_poly(i)>=0.1 && Y(i) > ycut
   icount=icount+1;
 lon(1:4,icount)=WL(i).X(1:4);
 lon(5,icount)=WL(i).X(1);
 lat(1:4,icount)=WL(i).Y(1:4);
...
%axis(axy)
plot([axy(1) axy(2) axy(2) axy(1) axy(1)],[axy(3) axy(3) axy(4) axy(4) axy(3)],'r-')
