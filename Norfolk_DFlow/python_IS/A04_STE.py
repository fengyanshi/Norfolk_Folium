...
flood_NF=os.path.join('../saved_images','IS_STE_138nm.png')
flood_NF_1=os.path.join('../saved_images','IS_STE_96nm.png')
flood_NF_2=os.path.join('../saved_images','IS_STE_54nm.png')
...
m.save(os.path.join('../saved_maps', 'IS_STE.html'))
m
