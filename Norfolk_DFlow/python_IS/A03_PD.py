...
flood_NF=os.path.join('../saved_images','IS_PD_0.88.png')
flood_NF_1=os.path.join('../saved_images','IS_PD_0.76.png')
flood_NF_2=os.path.join('../saved_images','IS_PD_0.64.png')
...
m.save(os.path.join('../saved_maps', 'IS_PD.html'))
m
