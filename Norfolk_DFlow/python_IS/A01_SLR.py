...
flood_NF=os.path.join('../saved_images','IS_SLR_1.3m.png')
flood_NF_1=os.path.join('../saved_images','IS_SLR_0.8m.png')
flood_NF_2=os.path.join('../saved_images','IS_SLR_0.4m.png')
...
m.save(os.path.join('../saved_maps', 'IS_SLR.html'))
m
