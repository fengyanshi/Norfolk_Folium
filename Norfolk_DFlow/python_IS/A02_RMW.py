...
flood_NF=os.path.join('../saved_images','IS_RMW_1.25.png')
flood_NF_1=os.path.join('../saved_images','IS_RMW_1.1.png')
flood_NF_2=os.path.join('../saved_images','IS_RMW_0.9.png')
...
m.save(os.path.join('../saved_maps', 'IS_RMW.html'))
m
