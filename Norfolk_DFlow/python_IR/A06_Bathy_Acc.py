...
flood_NF=os.path.join('../saved_images','Bathy_Acc_0.3m.png')
flood_NF_1=os.path.join('../saved_images','Bathy_Acc_0.5m.png')
flood_NF_2=os.path.join('../saved_images','Bathy_Acc_1.0m.png')
...
map_title = "Scenarios: Bathy Accuracy"
...
m.save(os.path.join('../saved_maps', 'Bathy_Acc.html'))
m
