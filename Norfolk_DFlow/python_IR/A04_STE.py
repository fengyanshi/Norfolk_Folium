...
flood_NF=os.path.join('../saved_images','STE_138nm.png')
flood_NF_1=os.path.join('../saved_images','STE_96nm.png')
flood_NF_2=os.path.join('../saved_images','STE_54nm.png')
...
m.save(os.path.join('../saved_maps', 'STE.html'))
m
