...
#flood_NF=os.path.join('../saved_images','WSF_0.925.png')
#flood_NF_1=os.path.join('../saved_images','WSF_1.075.png')
#flood_NF_2=os.path.join('../saved_images','WSF_1.225.png')
...
m.save(os.path.join('../saved_maps', 'Baseline.html'))
m
