...
flood_NF=os.path.join('../saved_images','Bathy_Res_F05.png')
flood_NF_1=os.path.join('../saved_images','Bathy_Res_F16.png')
flood_NF_2=os.path.join('../saved_images','Bathy_Res_F33.png')
flood_NF_3=os.path.join('../saved_images','Bathy_Res_F66.png')
...
map_title = "Scenarios: Bathy Resolution"
...
m.save(os.path.join('../saved_maps', 'Bathy_Res.html'))
m
