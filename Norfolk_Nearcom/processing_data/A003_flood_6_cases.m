...
if k==5 
fdir0=[froot fcase{1} '/'];
eta0=load([fdir0 'eta_0001'],'-ascii');
mask0=load([fdir0 'mask_0001'],'-ascii');
else
eta0=load([fdir 'eta_0001'],'-ascii');
mask0=load([fdir 'mask_0001'],'-ascii');
end
...
b=pcolor(X,Y,floodmask),shading interp
%set(b,'FaceAlpha',0.8);
