...
flood_NF_1=os.path.join('../saved_images','D_IR_Base_ERA5_flood.png')
flood_NF_2=os.path.join('../saved_images','D_IR_Base_HM_flood.png')
flood_NF_3=os.path.join('../saved_images','D_IR_RMW_F1.25_flood.png')
flood_NF_4=os.path.join('../saved_images','D_IR_WSF_1.225_flood.png')
flood_NF_5=os.path.join('../saved_images','D_IR_Bathy_Acc_GN_1m_flood.png')
flood_NF_6=os.path.join('../saved_images','D_IR_SLR_1.3M_flood.png')

fld_bar=os.path.join('../saved_images','colorbar_eta.png')

m=folium.Map([36.96238,-76.2842],zoom_start=14.5,control_scale=True)

map_title = "Flooded Area (Nearcom)"
...
m.save(os.path.join('../saved_maps', 'Nearcom_flood.html'))
m
