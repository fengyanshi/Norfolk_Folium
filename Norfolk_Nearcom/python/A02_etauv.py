...
flood_NF_1=os.path.join('../saved_images','D_IR_Base_ERA5_etauv.png')
flood_NF_2=os.path.join('../saved_images','D_IR_Base_HM_etauv.png')
flood_NF_3=os.path.join('../saved_images','D_IR_RMW_F1.25_etauv.png')
flood_NF_4=os.path.join('../saved_images','D_IR_WSF_1.225_etauv.png')
flood_NF_5=os.path.join('../saved_images','D_IR_Bathy_Acc_GN_1m_etauv.png')
flood_NF_6=os.path.join('../saved_images','D_IR_SLR_1.3M_etauv.png')

fld_bar=os.path.join('../saved_images','colorbar_eta.png')

m=folium.Map([36.96238,-76.2842],zoom_start=14.5,control_scale=True)

map_title = "Nearshore circulation (vectors) and elevation (color)"
...
img1=folium.raster_layers.ImageOverlay(
    name='Baseline ERA5',
    image=flood_NF_1,
    bounds=[[36.9400,-76.3100],[36.9750,-76.2550]],
    opacity=0.7,
    interactive=True,
    cross_origin=False,
    zindex=1,
...
m.save(os.path.join('../saved_maps', 'Nearcom_Eta_uv.html'))
m
